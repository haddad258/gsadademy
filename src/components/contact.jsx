...
export class Contact extends React.Component {
  ...
  handleSubmit(event) {
    ...
    axios.post(urlbackend+"/api/v1/student1site",{
      name:this.state.nom,
          ...
          <div className="container" style={{ width: "60vw" }}>
            <div style={{ display: "flex", flexDirection: "row" }}>
              <div style={{ width: "35vw" }}>
                <div style={{ color: "#fff", fontFamily: "Oswald", fontSize: "35px", textTransform: "uppercase" }}>Nous contacter </div>
                ...
                <form name="sentMessage" id="contactForm" noValidate onSubmit={this.handleSubmit}>
                  ...
                  <textarea
                    name="message"
                    style={{ width: "100%", marginTop: "30px 4%", paddingTop:"10px", backgroundColor: "#292929", color: "#ffffff" }}
                    id="message"
                    className="form-control"
                    rows="4"
                    placeholder="Message"
